<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Quản lý các xin việc của <?php echo $cv['employee']['full_name'];?></li>
    </ol>
</section>
...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <?php echo $this->Form->create(null,['url' => ['controller' => 'ApplyCvs', 'action' => 'process', 'cv_id' => $cv['id']], 'id' => 'form_action']);?>
                        ...
                        <h3 class="box-title">
                            <div class="btn-group">
                                <?php echo $this->Html->link(
                                        'Thêm mới',
                                        array('controller' => 'ApplyCvs', 'action' => 'add', 'cv_id' => $cv['id']),
