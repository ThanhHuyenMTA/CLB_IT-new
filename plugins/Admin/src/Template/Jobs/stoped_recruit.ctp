...
<section class="content-header">
    <h1>
        Quản lý
        <small>Công việc | Các tin ngừng tuyển</small>
    </h1>
    <ol class="breadcrumb">
        <li>
            <?php 
                ...
                <?php echo $this->Form->create(null,['url' => ['controller' => 'Jobs', 'action' => 'process'], 'id' => 'form_action']);?>
                    ...
                    <div class="box-header">
                        <h3 class="box-title">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-default btn-flat action_submit" value="6">Đăng lại</button>
                        ...
                        <div class="bs-callout bs-callout-info" id="callout-alerts-no-default">
                            <h4>Hướng dẫn</h4> 
                            <p><span><i class="fa fa-warning"></i> Ngưng tuyển dụng</span></p>
                            <p><span>[Đăng lại] </span>Tạo ra tin mới với nội dung tương tự và trạng thái chưa kích hoạt, đồng thời xóa tin cũ</p>
                        </div>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($jobs as $row): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <?php if ($row['status'] == 2): ?>
                                                <i class="fa fa-warning"><span class="hidden"><?= $row['status']?></span></i>
                                            <?php endif; ?>
                                        <!-- </td> -->
