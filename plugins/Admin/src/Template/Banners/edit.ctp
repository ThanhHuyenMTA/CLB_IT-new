...
<?php echo $this->Html->script(array('Admin.tether.min', 'Admin.cropper.min', 'jquery.validate.min', 'Admin.banners_edit')); ?>
...
<div class="container">
    <div class="col-sm-12 create-cv">
        ...
        echo $this->Form->input('id', array('type' => 'hidden', 'value' => $bannerFind->id));
        ?>
        <div class='cv-information' style="margin-top: 20px;">
            <div class='cv-information-left col-md-12'>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <?= $this->Form->input('title1', ['label' => false, 'class' => 'form-control', 'id' => 'title1', 'value' => $bannerFind->title1]) ?>
                    </div>
                </div>
                <div class="form-group">
                    <label for="full_name" class="col-md-2 control-label">Title 2</label>
                    <div class="col-md-8">
                        <?= $this->Form->input('title2', ['label' => false, 'class' => 'form-control', 'id' => 'title2', 'value' => $bannerFind->title2]) ?>
                    </div>
                </div>
                <div class="form-group">
                    <label for="full_name" class="col-md-2 control-label">Title3</label>
                    <div class="col-md-8">
                        <?= $this->Form->input('title3', ['label' => false, 'class' => 'form-control', 'id' => 'title3', 'value' => $bannerFind->title3]) ?>
                    </div>
                </div>
                <div class="form-group">
                    <label for="full_name" class="col-md-2 control-label">Chiều rộng</label>
                    <div class="col-md-8">
                        <?= $this->Form->input('width', ['label' => false, 'class' => 'form-control', 'id' => 'width', 'readonly' => true, 'value' => $bannerFind->width]) ?>
                    </div>
                </div>
                <div class="form-group">
                    <label for="full_name" class="col-md-2 control-label">Chiều cao</label>
                    <div class="col-md-8">
                        <?= $this->Form->input('height', ['label' => false, 'class' => 'form-control', 'id' => 'height', 'readonly' => true, 'value' => $bannerFind->height]) ?>
                    </div>
                </div>
                <div class="form-group">
                    <label for="full_name" class="col-md-2 control-label">Tọa độ X</label>
                    <div class="col-md-8">
                        <?= $this->Form->input('x', ['label' => false, 'class' => 'form-control', 'id' => 'x', 'readonly' => true, 'value' => $bannerFind->x]) ?>
                    </div>
                </div>
                <div class="form-group">
                    <label for="full_name" class="col-md-2 control-label">Tọa độ Y</label>
                    <div class="col-md-8">
                        <?= $this->Form->input('y', ['label' => false, 'class' => 'form-control', 'id' => 'y', 'readonly' => true, 'value' => $bannerFind->y]) ?>
                    </div>
                </div>
                <div class="form-group">
                    <label for="full_name" class="col-md-2 control-label">Order sort</label>
                    <div class="col-md-8">
                        <?= $this->Form->input('order_sort', ['label' => false, 'class' => 'form-control', 'id' => 'order_sort', 'value' => 50, 'type' => 'number', 'value' => $bannerFind->order_sort]) ?>
                    </div>
                </div>
                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <div class="img-container">
                                    <img src="<?= '../' . $bannerFind->url; ?>" alt="Picture">
                                </div>
                            </div>
                            <div class="col-md-3">
        ...
        <div class="submit-created-cv text-center">
            <button type="submit" class="btn btn-create-cv" formnovalidate = true>SỬA BANNER</button>
            <button type="reset" class="btn btn-cancel"><?= $this->Html->link('Hủy', ['controller' => 'banners', 'action' => 'index'], ['style' => 'color: black;'])?></button>
        </div>
        <?php $this->Form->end(); ?>
    </div><!--/.col (right) -->
</div><!-- /.container -->