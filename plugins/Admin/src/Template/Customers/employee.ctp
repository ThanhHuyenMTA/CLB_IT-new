...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <?php echo $this->Form->create(null,['url' => ['controller' => 'Customers', 'action' => 'employeeProcess'], 'id' => 'form_action']);?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $this->Html->link(
                                            ...
                                            array('controller' => 'Customers', 'action' => 'employeeEdit', 'id' => $row['id']));?>
                                </td>
                                <td><?php echo $row['email']; ?></td>
                                <td><?php echo $row['mobile']; ?></td>
                                <td>
                                    <?php
                                    $countCv = isset($row['cvs']) ? count($row['cvs']) : 0;
                                    $idCV = $row['id'];                                   
                                    echo $this->Html->link(
                                        'CV (' . $countCv . ')',
                                        array(
